<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:79:"/www/wwwroot/qnq.nuosike.cn/public/../application/admin/view/category/edit.html";i:1611259786;s:70:"/www/wwwroot/qnq.nuosike.cn/application/admin/view/layout/default.html";i:1583049508;s:67:"/www/wwwroot/qnq.nuosike.cn/application/admin/view/common/meta.html";i:1583049508;s:69:"/www/wwwroot/qnq.nuosike.cn/application/admin/view/common/script.html";i:1583049508;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-bt1a" class="form-control" name="row[bt1a]" type="text" value="<?php echo $row['bt1a']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-bt1b" class="control-label col-xs-12 col-sm-2">按钮颜色</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-bt1b" class="form-control" name="row[bt1b]" type="text" value="<?php echo $row['bt1b']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-bt2a" class="form-control" name="row[bt2a]" type="text" value="<?php echo $row['bt2a']; ?>">
        </div>
    </div>
     <div class="form-group">
        <label for="c-bt2b" class="control-label col-xs-12 col-sm-2">是否付费:<br>付费为:true</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-bt2b" class="form-control" name="row[bt2b]" type="text" value="<?php echo $row['bt2b']; ?>">
      ...
      <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-beizhu" class="form-control" name="row[beizhu]" type="text" value="<?php echo $row['beizhu']; ?>">
        </div>
    </div>
