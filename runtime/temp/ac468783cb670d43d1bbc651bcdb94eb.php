...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-flag" class="control-label col-xs-12 col-sm-2">是否蓝秦云链接:</label>
        <div class="col-xs-12 col-sm-8">
             <select class="form-control"  name="row[flag]" >
			<option value="0" <?php if($row['flag']=='0'): ?>selected<?php endif; ?>>非蓝秦云</option>
            <option value="1" <?php if($row['flag']=='1'): ?>selected<?php endif; ?>>蓝秦云</option> 
            </select>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
     ...
     <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
			...
			<option value="0" <?php if($row['bt2b']=='0'): ?>selected<?php endif; ?>>免费</option>
            <option value="1" <?php if($row['bt2b']=='1'): ?>selected<?php endif; ?>>付费</option> 
            </select>
        </div>
        </div>
