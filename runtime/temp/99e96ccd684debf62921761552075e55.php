<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"/www/wwwroot/old.nuosike.com/public/../application/admin/view/general/config/index.html";i:1652428243;s:71:"/www/wwwroot/old.nuosike.com/application/admin/view/layout/default.html";i:1583049508;s:68:"/www/wwwroot/old.nuosike.com/application/admin/view/common/meta.html";i:1583049508;s:70:"/www/wwwroot/old.nuosike.com/application/admin/view/common/script.html";i:1583049508;}*/ ?>
<!DOCTYPE html>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="submit" onclick="update()" class="btn btn-danger btn-embossed">检查更新</button>
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
...
function update(){
     $.ajax({
        type: 'POST',
        url: 'general/config/update',
        dataType: 'json',
        success: function (str) {
            if(str.code == 200){
                layer.confirm(str.msg, {
                  btn: ['确认更新', '取消更新'] //可以无限个按钮
                    ...
                    $.ajax({
                        ...
                        success: function (str) {
                            if(str.code == 200){
                                layer.alert(str.msg, { icon: 1, closeBtn: 0 }, function (index) { 
                                	layer.closeAll();
                                });
                            }else{
                                layer.alert(str.msg, { icon: 1, closeBtn: 0 }, function (index) { 
